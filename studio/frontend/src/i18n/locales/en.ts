...
export const en = {
  modelStorage: {
    ...
    action: "Move model",
    restoreMenu: "Restore original location…",
    restoreTitle: "Restore original location",
    restoreDescription: "Move {model} back to the local Hugging Face cache it used before it was moved to another disk.",
    restoreWarning: "Keep the external disk connected until the restore finishes. The external registration is removed only after the local copy has been verified.",
    restoreAction: "Restore model",
    restoreQueued: "Waiting to restore…",
    restoreChecking: "Checking model and local free space…",
    restoreCopying: "Copying model back…",
    restoreVerifying: "Verifying the local copy…",
    restoreFinishing: "Finishing the restore…",
    restoreCompleted: "Model restored",
    restoreCancelled: "Restore cancelled. External model kept.",
    restoreFailed: "Could not restore the model.",
