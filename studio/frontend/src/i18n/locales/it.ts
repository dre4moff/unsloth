...
export const it = {
  modelStorage: {
    ...
    restoreMenu: "Ripristina posizione originale…",
    restoreTitle: "Ripristina posizione originale",
    restoreDescription: "Riporta {model} nella cache locale di Hugging Face usata prima dello spostamento su un altro disco.",
    restoreWarning: "Mantieni collegato il disco esterno fino al termine. La posizione esterna viene rimossa solo dopo la verifica della copia locale.",
    restoreAction: "Ripristina modello",
    restoreQueued: "In attesa del ripristino…",
    restoreChecking: "Verifica del modello e dello spazio locale…",
    restoreCopying: "Copia del modello nella posizione originale…",
    restoreVerifying: "Verifica della copia locale…",
    restoreFinishing: "Completamento del ripristino…",
    restoreCompleted: "Modello ripristinato",
    restoreCancelled: "Ripristino annullato. Modello esterno conservato.",
    restoreFailed: "Impossibile ripristinare il modello.",
